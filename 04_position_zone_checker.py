...
PURPOSE:
    ...
    This is the HEART of the geofencing system. In production, this logic ran
...
print("    Manufacturing Warehouse — Shift 2024-03-15 08:00")
print("="*60)
...
ax.set_title(
    "Manufacturing Warehouse — AGV Position Tracking & Zone Violations\n"
