...
PURPOSE:
    Build a digital twin of a manufacturing warehouse facility using Shapely
...
PRODUCTION CONTEXT:
    In production, this warehouse map was stored as a versioned GeoJSON
...
warehouse_gdf = gpd.GeoDataFrame(
    ...
    # This is the appropriate projected CRS for western NY state.
...
ax.set_title(
    "Manufacturing Warehouse — Structural Layout\n"
